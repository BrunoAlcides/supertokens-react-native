...
export default class FrontToken {
    ...
    static getFrontTokenFromStorage() {
        return __awaiter(this, void 0, void 0, function* () {
            let frontTokenFromStorage = yield Storage.getStringAsync(FRONT_TOKEN_KEY);
            ...
            function setFrontTokenToStorage(frontToken) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (frontToken === undefined) {
                        yield Storage.removeItem(FRONT_TOKEN_KEY);
                    }
                    else {
                        yield Storage.setStringAsync(FRONT_TOKEN_KEY, frontToken);
                    }
                });
            }
