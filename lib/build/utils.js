...
export function storeInStorage(name, value, expiry) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (value === "") {
            return yield Storage.removeItem(storageKey);
        }
        return yield Storage.setStringAsync(storageKey, value);
    });
}
/**
...
function getFromStorage(name) {
    return __awaiter(this, void 0, void 0, function* () {
        const itemInStorage = yield Storage.getStringAsync(`st-storage-item-${name}`);
